...
<div class="nav-center">
  <ul class="nav nav-pills" role="tablist">
    <li class="nav-item">
    	<a class="nav-link active" href="#ttu-one" role="tab" data-toggle="tab">2015 Highlights</a>
    </li>
    <li class="nav-item">
    	<a class="nav-link" href="#ttu-two" role="tab" data-toggle="tab">2014 Highlights</a>
    </li>
  </ul> <!-- /.nav-tabs -->
</div> <!-- /.nav-center -->  
	...
	<div class="event">
		...
		<div class="col-md-9 col-md-push-3">
			...
			<ul class="panelists list-unstyled">
				...
				<p class="p-listing"><strong>Miranda Site</strong><br />
				<span class="p-title">Creative Coordinator, VOX Media, last year’s hackathon winner</span></p></a>
